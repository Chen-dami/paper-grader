...
with tab1:
    ...
    builtin_tiers = {
        "relaxed": {"贴合主题": (0.90, 1.0), "跑题": (0.40, 0.60),
                    "有视频": (0.85, 1.0), "无视频": (0.30, 0.45),
                    "有截图": (0.80, 1.0), "无截图": (0.30, 0.50),
                    "有表格": (0.80, 1.0),
                    "有链接": (0.80, 1.0), "无链接": (0.30, 0.45),
                    "素材不足": (0.15, 0.30), "敷衍": (0.25, 0.40),
                    "空": (0, 0), "desc": "鼓励为主"},
        "normal":  {"贴合主题": (0.80, 1.0), "跑题": (0.35, 0.55),
                    "有视频": (0.75, 1.0), "无视频": (0.25, 0.40),
                    "有截图": (0.70, 1.0), "无截图": (0.25, 0.45),
                    "有表格": (0.70, 1.0),
                    "有链接": (0.70, 1.0), "无链接": (0.25, 0.40),
                    "素材不足": (0.10, 0.25), "敷衍": (0.20, 0.35),
                    "空": (0, 0), "desc": "平衡"},
        "strict":  {"贴合主题": (0.70, 1.0), "跑题": (0.25, 0.45),
                    "有视频": (0.60, 1.0), "无视频": (0.20, 0.35),
                    "有截图": (0.55, 1.0), "无截图": (0.20, 0.40),
                    "有表格": (0.55, 1.0),
                    "有链接": (0.55, 1.0), "无链接": (0.20, 0.35),
                    "素材不足": (0.05, 0.20), "敷衍": (0.15, 0.30),
                    "空": (0, 0), "desc": "严格"},
    }
