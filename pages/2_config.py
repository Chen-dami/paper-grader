...
with tab1:
    ...
    builtin_tiers = {
        "relaxed": {"贴合主题": (0.95, 1.0), "跑题": (0.35, 0.55),
                    "有视频": (0.90, 1.0), "无视频": (0.30, 0.45),
                    "有截图": (0.85, 1.0), "无截图": (0.30, 0.50),
                    "有表格": (0.85, 1.0),
                    "有链接": (0.85, 1.0), "无链接": (0.30, 0.45),
                    "素材不足": (0.10, 0.25), "敷衍": (0.20, 0.35),
                    "空": (0, 0), "desc": "鼓励为主"},
        "normal":  {"贴合主题": (0.85, 1.0), "跑题": (0.30, 0.50),
                    "有视频": (0.80, 0.95), "无视频": (0.25, 0.40),
                    "有截图": (0.75, 0.95), "无截图": (0.25, 0.45),
                    "有表格": (0.80, 0.95),
                    "有链接": (0.75, 0.95), "无链接": (0.25, 0.40),
                    "素材不足": (0.10, 0.25), "敷衍": (0.20, 0.35),
                    "空": (0, 0), "desc": "平衡"},
        "strict":  {"贴合主题": (0.80, 1.0), "跑题": (0.25, 0.45),
                    "有视频": (0.70, 0.85), "无视频": (0.20, 0.35),
                    "有截图": (0.65, 0.85), "无截图": (0.20, 0.40),
                    "有表格": (0.70, 0.90),
                    "有链接": (0.65, 0.85), "无链接": (0.20, 0.35),
